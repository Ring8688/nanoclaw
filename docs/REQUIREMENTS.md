...
- `/convert-to-whatsapp` - Replace Telegram with WhatsApp

### Container Runtime
The project uses Docker for cross-platform container isolation.

### Platform Support
- `/setup-linux` - Linux-specific setup optimizations
...
- Use existing tools (Telegram connector, Claude Agent SDK, MCP servers)
- Minimal glue code
...
### Skills
- `/setup` - Install dependencies, configure Telegram bot, configure scheduler, start services
